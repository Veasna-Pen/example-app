<template>
    <div class="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
        <ul class="flex flex-row lg:flex-row justify-center items-center dark:text-gray-400">
            <li class="mr-2">
            ...
            <li class="cursor-pointer capitalize mr-2" v-for="projectSkill in categories.data" :key="projectSkill.id">
        ...
        <section class="pt-4 grid gap-y-12 lg:grid-cols-3 lg:gap-8">
