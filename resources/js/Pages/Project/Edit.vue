        ...
        <div class="py-3">
            <div class="max-w-full mx-auto sm:px-6 lg:px-6">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <form @submit.prevent="updateProject" class="p-4">
                        <div>
                        ...
                        <div class="mt-3">
                            ...
                            <TextInput id="name" type="text" class="mt-1 block w-full" v-model="form.project_url" />
                            ...
                            <form>
                                <div
                                    ...
                                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                        ...
                                        <textarea v-model="form.description" id="editor" rows="8"
